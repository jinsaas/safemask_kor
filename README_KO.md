...
이젠 업로드 위젯으로도 열 수 있습니다.(가능하면 Mask폴더 내의 마스크를 불러오는게 충돌 위험이 줄어듭니다.)
...
-이미지 패딩 컬러옵션 추가 : neutral gray(128,128,128)
(샘플링 시 공백영역처럼 샘플링을 합니다.)

### V4.1.2 정보

-테이퍼드 코너 버그패치

-프리뷰 로직을 이미지프리뷰 기준으로 변경

-크롭 마진 마스크 노드 추가. 중앙을 축으로 잡아 외부를 입력한 픽셀만큼 자릅니다.
...
#### Safe CenterCrop Mask Node : 안정화노드. 중앙을 기준으로 상하좌우로 직접 자를 픽셀을 지정.
##오류수정, 자체미리보기 추가
